  ...
  { -- Telescope
    ...
    config = function()
      require('telescope').setup {
        -- leave defaults mostly untouched
        extensions = {
          ['ui-select'] = {
      ...
      -- Hidden: find files (include hidden)
      vim.keymap.set('n', '<leader>sF', function()
        builtin.find_files {
          hidden = true,
      ...
      -- Hidden: live grep (include hidden)
      vim.keymap.set('n', '<leader>sG', function()
        builtin.live_grep {
          additional_args = function()
            return {
